...
SD_Error SD_GetCardInfo(SD_CardInfo *cardinfo)
{
  ...
  if ((CardType == SDIO_STD_CAPACITY_SD_CARD_V1_1) || (CardType == SDIO_STD_CAPACITY_SD_CARD_V2_0))
  {
	...
	printf("\n\r 该SD卡类型：SDIO_STD_CAPACITY_SD_CARD_V1_1或SDIO_STD_CAPACITY_SD_CARD_V2_0");
	printf("\n\r ShenZhouSD CardBlockSize %d SD卡容量是： %dM", cardinfo->CardBlockSize, cardinfo->CardCapacity / 1024 / 1024);
  }
  else if (CardType == SDIO_HIGH_CAPACITY_SD_CARD)
  {
	...
	printf("\n\r 该SD卡的类型是：SDIO_HIGH_CAPACITY_SD_CARD");
  ...
  printf("\n\r SD卡制造日期: 20%02d.%d! \n", (cardinfo->SD_cid.ManufactDate & 0x0ff0)>>4, (cardinfo->SD_cid.ManufactDate & 0x0f));
