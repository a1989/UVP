...
__heap_limit
                ...
                IMPORT  BSP_IntHandlerUART8              
                IMPORT  BSP_IntHandlerSPI4                
                IMPORT  BSP_IntHandlerSPI5                
                IMPORT  BSP_IntHandlerSPI6                
                IMPORT  BSP_IntHandlerSAI1                
                IMPORT  BSP_IntHandlerLTDC                
                IMPORT  BSP_IntHandlerLTDC_ER             
                IMPORT  BSP_IntHandlerDMA2D 
...
__Vectors       DCD     __initial_sp                      ; Top of Stack
                ...
                DCD     BSP_IntHandlerFSMC                ; 64, INTISR[ 48]  FMC global Interrupt.
                ...
                DCD     BSP_IntHandlerUART7               ; 98, INTISR[ 82]  UART7 global Interrupt.
                DCD     BSP_IntHandlerUART8               ; 98, INTISR[ 83]  UART8 global Interrupt.
                DCD     BSP_IntHandlerSPI4                ; 99, INTISR[ 84]  SPI4 global Interrupt.
                DCD     BSP_IntHandlerSPI5                ;100, INTISR[ 85]  SPI5 global Interrupt.
                DCD     BSP_IntHandlerSPI6                ;101, INTISR[ 86]  SPI6 global Interrupt.
                DCD     BSP_IntHandlerSAI1                ;102, INTISR[ 87]  SAI1 global Interrupt.
                DCD     BSP_IntHandlerLTDC                ;103, INTISR[ 88]  LTDC global Interrupt.
                DCD     BSP_IntHandlerLTDC_ER             ;104, INTISR[ 89]  LTDC ERROR global Interrupt.
                DCD     BSP_IntHandlerDMA2D               ;105, INTISR[ 90]  DMA2D global Interrupt.
