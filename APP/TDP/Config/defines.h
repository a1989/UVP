...
#define HOMING_FEEDRATE {100*6, 100*6, 20*60, 0}
...
//#define X_STEP_PIN_PORT			GPIOC
//#define X_STEP_PIN        	GPIO_Pin_4
//#define X_ENABLE_PIN_PORT		GPIOC
//#define X_ENABLE_PIN				GPIO_Pin_5

#define Y_DIR_PIN_PORT			GPIOF
#define Y_DIR_PIN						GPIO_Pin_1
#define Y_STEP_PIN_PORT			GPIOF
#define Y_STEP_PIN        	GPIO_Pin_0
#define Y_ENABLE_PIN_PORT		GPIOC
...
#define Z_ENABLE_PIN_PORT		GPIOE
#define Z_ENABLE_PIN				GPIO_Pin_5
...
#define Y_MIN_PIN						-1
#define Z_MIN_PIN_PORT			GPIOE
#define Z_MIN_PIN						GPIO_Pin_4
//#define Z_MIN_PIN_PORT			GPIOF
//#define Z_MIN_PIN						GPIO_Pin_5

#define X_MAX_PIN_PORT      GPIOF
#define X_MAX_PIN         	GPIO_Pin_2
#define Y_MAX_PIN_PORT      GPIOC
...
#define E0_ENABLE_PIN_PORT		GPIOB
#define E0_ENABLE_PIN					GPIO_Pin_0
#define E0_STEP_PIN_PORT			GPIOC
#define E0_STEP_PIN						GPIO_Pin_4
#define E0_DIR_PIN_PORT				GPIOC
#define E0_DIR_PIN						GPIO_Pin_5


#define HEATER_END_PIN_PORT		GPIOB
#define HEATER_END_PIN				GPIO_Pin_8

#define HEATER_BED_PIN_PORT		GPIOB
